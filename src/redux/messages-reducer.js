...
const ADD_MESSAGE = "messages/ADD_MESSAGE";
 ...
 let initialState = {
    Messages: [
        ...
        { id: 5, messageText: "Привет, что делал сегодня? Я очень скучаю" },
        { id: 6, messageText: "Дарова, сидел учил реакт по видосам Димыча" },
        { id: 7, messageText: "Аахахах" },
        { id: 8, messageText: "3543543535435435453" },
        { id: 9, messageText: "Привет, что делал сегодня? Я очень скучаю" },
        { id: 10, messageText: "Дарова, сидел учил реакт по видосам Димыча" },
        { id: 11, messageText: "Аахахах" },
        { id: 12, messageText: "Видел этот мем на пикабе" },
        { id: 13, messageText: "Привет, что делал сегодня? Я очень скучаю" },
